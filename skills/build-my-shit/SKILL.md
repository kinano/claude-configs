...
6. Once the agent(s) are done, run `/critique-my-shit` with the implementation plan and all impacted repos to ensure changes are reviewed, committed, and pushed.
